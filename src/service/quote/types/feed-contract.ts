...
export type ContractContext = EthersContractContextV5<
  FeedContract,
  FeedContractMethodNames,
  FeedContractEventsContext,
  FeedContractEvents
>;
...
export type FeedContractEvents =
  | 'AnswerUpdated'
  | 'NewRound'
  | 'OwnershipTransferRequested'
  | 'OwnershipTransferred';
export interface FeedContractEventsContext {
...
export type FeedContractMethodNames =
  | 'new'
  | 'acceptOwnership'
  | 'accessController'
  | 'aggregator'
